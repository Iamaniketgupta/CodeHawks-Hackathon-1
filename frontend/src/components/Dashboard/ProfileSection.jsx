...
<h2 className="font-bold text-center text-3xl mt-4">Profile</h2>
            ...
            {user && (
                <div className=" text-white flex-1 min-w-[300px] mx-auto my-5 p-2 shadow-sm shadow-[#181E29] rounded-md">
                    <div className="p-3">
                        <img src={user?.user?.avatar || defaultavatar} alt="Avatar" className="w-32 h-32 border-2 rounded-full select-none" />
                    </div>
