...
const Home = () => {
    ...
    return (
        <>
            ...
            <section className="w-full h-[400px] flex items-center justify-center p-5 flex-wrap">
                <div className="max-w-[600px] min-w-[300px] flex-1">
                    <h1 className="my-5 font-bold text-5xl leading-tight">Make Your Teams and Connect with People </h1>
                    <p className="text-lg text-gray-600">Create collaborative teams effortlessly and achieve your goals together.</p>
                </div>
                <div className="max-w-[600px] min-w-[300px] h-full flex-1">
                    <img src={homeimg4} alt="" className="w-full h-full" />
                </div>
            </section>
            ...
            <section className="w-full h-[400px] ">
                <div className=" min-w-[300px] ">
                    <h1 className="my-5 font-bold text-5xl leading-tight text-center">Meet the Developers</h1>
                </div>
                <div className=" min-w-[300px] text-2xl flex items-center justify-center p-5 gap-3 flex-wrap">

                <a href="https://linkedin.com/in/iamaniketgupta" target="_blank">  <h3 className="p-5 bg-blue-600 rounded-lg text-white font-bold m-4">Aniket Gupta</h3> </a>
                    <a href="https://linkedin.com/in/suraj-singh-431010248" target="_blank"><h3 className="p-5 bg-blue-600 rounded-lg text-white font-bold m-4">Suraj Singh</h3></a>
                </div>
            </section>
